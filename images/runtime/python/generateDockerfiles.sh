...
declare -r PYTHON_STRETCH_VERSION_ARRAY=($PYTHON27_VERSION $PYTHON36_VERSION)
ImageDebianFlavor="$1"
...
do
    ...
    RUNTIME_BASE_IMAGE_NAME="mcr.microsoft.com/oryx/base:python-$MAJOR_MINOR_VERSION-$PYTHON_RUNTIME_BASE_TAG"
